...
# Usage example
file_path = 'lockdown.txt'
contingency_matrix = process_tweets(file_path)

# Print the contingency matrix
total_emojis = sum(contingency_matrix.values())
print(f"Contingency Matrix:")
print(f"{'Emoji':<8} {'Count':<8} {'Emoji':<8} {'Count':<8} {'Emoji':<8} {'Count':<8} {'Emoji':<8} {'Count':<8} {'Emoji':<8} {'Count':<8}")
print("-" * 68)
row_count = 0
for emoji, count in contingency_matrix.most_common():
    if row_count % 5 == 0:
        print()
